...
<br>
	<h3>Contact Form</h3>
		<form  action="{{url('/contact-us-save')}}" method="POST" role="form">
		{{csrf_field()}}
			...
			<div class="form-group">
				<label>Message</label>
				<textarea class="form-control form-control-message" name="message" id="message"  rows="10" required></textarea>
			</div>
			<div class="text-right"><br>
				<button type="submit" class="btn btn-primary solid blank" >Send Message</button> 
			</div>
		</form>
